...
const getStatusLabel = (pending, dispatch) => {
  if (pending) {
          ...
          <tbody>
            {order.map((order, index) => (
              <tr key={index + 1}>
                ...
                <td>{getStatusLabel(order.pending, order.dispatch)}</td>
                <td>
                  <FaEye
                    onClick={() => {
              ...
              if (order.pending) {
                return (
                  <tr key={index + 1}>
                    ...
                    <td> {order.dispatch ? <span style={{ color: "orange" }}>Dispatch</span> : <span style={{ color: "green" }}>Pending</span>}</td>
                    <td>
                      <FaEye
                        onClick={() => {
                          handleShowModal(order);
