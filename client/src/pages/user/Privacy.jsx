            ...
            <div className='privacy'>
                ...
                <div className='body-content'>
                    <div className='body-part'>
                        <ol>
                            <li><a className='heading' href='#item1'>PURPOSE</a></li>
                            <li><a className='heading' href='#item2'>WHAT IS PERSONAL DATA?</a></li>
                            <li><a className='heading' href='#item3'>PERSONAL DATA COLLECTED</a></li>
                            <li><a className='heading' href='#item4'>ACCESSING YOUR PERSONAL DATA</a></li>
                            <li><a className='heading' href='#item5'>COMPLAINTS</a></li>
                            <li><a className='heading' href='#item6'>OWNER AND DATA CONTROLLER</a></li>
                        </ol>
                    </div>
                </div>
            </div>
            <div className='data'>
                <div className='purpose' id='item1'>
                    ...
                    <div className='purpose-data'>
                        <p>Little & Big is committed to protecting your privacy because we are committed to valuing people. Our Privacy Policy below sets out how your personal information is collected, used and protected. The Demo Country Privacy Principles also apply to us.</p>
