        ...
        <div className="Register-row">
          ...
          <div className="Register-form">
            <form onSubmit={handleUserDataSubmit}>
              ...
              />
              {error.userName.status === true ? (<div className="form_error">
                <div >
              ...
              />
              {error.email.status === true ? (<div className="form_error">
                <div >
                  <FaStar id="form_error_icon" />
                </div>
                <div>
              ...
              <input
                ...
                name="repeatPassword"
                value={userData.confirmPassword} onChange={(e) => {
                  setUserData({ ...userData, confirmPassword: e.target.value });
                  setError({ ...error, confirmPassword: { status: false, message: "" } });
                }}
              />
              {error.confirmPassword.status === true ? (<div className="form_error">
                <div >
                  <FaStar id="form_error_icon" />
                </div>
                <div>
